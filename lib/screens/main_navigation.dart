  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(icon: const Icon(Icons.home_outlined), label: appState.t("Home", "Home")),
          BottomNavigationBarItem(icon: const Icon(Icons.trending_up), label: appState.t("Sales", "Mauzo")),
          BottomNavigationBarItem(icon: const Icon(Icons.trending_down), label: appState.t("Exp", "Gharama")),
          BottomNavigationBarItem(icon: const Icon(Icons.inventory_2_outlined), label: appState.t("Stock", "Stoo")),
          BottomNavigationBarItem(icon: const Icon(Icons.people_outline), label: appState.t("Vendors", "Wauzaji")),
